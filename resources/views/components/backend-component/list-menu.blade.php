<div class="bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md h-full">
 <a href="/dashboard" wire:navigate
  class=" mb-3 flex justify-center border-b bg-white dark:bg-gray-800 border-gray-400 dark:border-gray-700"
  aria-label="Logo">
  <x-backend-component.application-logo
   class="w-28 h-12 mt-2 mb-2 text-violet-600 dark:text-violet-300 hover:text-violet-700 dark:hover:text-violet-500" />
 </a>
