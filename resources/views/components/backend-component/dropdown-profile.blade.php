...
<li class="z-10 sm:flex sm:items-center sm:ms-6">
            ...
            if (isDark) {
                ...
                document.documentElement.classList.remove('dark');
                    ...
                    <div class="flex space-x-2 mx-2">
                        ...
                        <button class="flex items-center gap-3 px-4 py-2 rounded-md text-gray-500 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-800" :class="theme === 'light' ? 'text-yellow-500 bg-gray-300 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400'" @click="lightMode()">
                        ...
                        <button class="flex items-center gap-3 px-4 py-2 rounded-md text-gray-500 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-800" :class="theme === 'dark' ? 'dark:text-violet-500 bg-gray-800' : 'text-gray-500 dark:text-gray-400'" @click="darkMode()">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                        ...
                        <!-- Button System Theme -->
                        <button class="flex items-center gap-3 px-4 py-2 rounded-md text-gray-500 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-800" :class="theme === undefined ? 'bg-gray-200 text-green-600 dark:text-green-500 dark:bg-gray-800' : 'text-gray-500 dark:text-gray-400'" @click="systemMode()">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
